...
SD1_data_pivot_longer <- SD1_clean %>% 
  ...
  mutate(ISSCapoA = str_replace_all(ISSCapoA, pattern = c('ISSCapoA1' = "Columbus RGSH", 
         ...
         ISSCapoB = str_replace_all(ISSCapoB, pattern = c('ISSCapoB1' = "Columbus air", 
                                                          'ISSCapoB2' = "Columbus light cover",
                                                          'ISSCapoB3' = "Columbus SSC laptop", 
                                                          'ISSCapoB4' = "Columbus handrails", 
                                                          'ISSCapoB5' = "Columbus RGSH", 
